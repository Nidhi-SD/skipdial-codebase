...
// --- DYNAMIC SPOTLIGHT WRAPPER ---
// This captures mouse coordinates to drive the radial-gradient hover glow
const SpotlightCard = ({ children, className, as: Component = motion.div }: { children: React.ReactNode, className?: string, as?: React.ElementType }) => {
